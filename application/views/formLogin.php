...
<head>
    ...
    <title>PT. RIMBA BESAR - Login</title>
...
<style>
    body {
        background: linear-gradient(to right, #6839ac, #cf9893);
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Aplikasi Penggajian <br><b>PT. RIMBA BESAR</b></h1>
                                    </div>
